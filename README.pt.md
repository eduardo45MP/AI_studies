...
AI_studies/
├── article/         # Artigos em formato complementar ao portfolio¹
...
├── index.html       # Base para visualização dos artigos
├── README.pt.md     # Este documento
└── README.md        # Este documento (Versão em Inglês)
